    ...
    return ( <div className="h-full w-full flex justify-center">
        <Card className="w-[400px] mt-48">
            <CardHeader>
                ...
                <CardDescription className="text-center">Daftar untuk bergabung</CardDescription>
            </CardHeader>
            <CardContent>
                <Form {...form} >
                    ...
                    <FormField 
                        ...
                        <Button className="w-full" disabled={isLoading}>Daftar</Button>
                        
                        <Link href="/login"><Button className="w-full mt-4" variant={"outline"}>Sudah punya akun? Masuk</Button></Link>
                    </form>
                </Form>
            </CardContent>
        </Card>
