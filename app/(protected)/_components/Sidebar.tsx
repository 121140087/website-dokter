    ...
    <div className="sticky top-0 left-0 w-[300px] items-center bg-white border-r-2 h-screen flex flex-col gap-y-8">
      ...
      <div className="flex flex-col w-full">
        ...
        <Link
          ...
          className="w-full p-4 border-b-2 border-slate-100 flex justify-between items-center"
        >
          Pesan
          <div className="rounded-full aspect-square flex items-center justify-center bg-slate-800 text-sm text-white p-1">
            12
          </div>
        </Link>
        <Link
